...
ClientMedia::ClientMedia(std::string url, std::string user, std::string password, bool showCapabilities) : ClientDevice(url, user, password, showCapabilities){
    if(_hasMedia){
...
int ClientMedia::getVideoSourceConfigurations(){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str())){
        return -1;
    }
...
int ClientMedia::getVideoEncoderConfigurations(){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str())){
        return -1;
    }
...
int ClientMedia::getVideoEncoderConfigurationOptions(std::string profileToken, std::string configurationToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str())){
        return -1;
    }
...
int ClientMedia::setVideoEncoderConfiguration(std::string configurationToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str())){
        return -1;
    }
...
int ClientMedia::getStreamURI(std::string profileToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str())){
        return -1;
    }
...
int ClientMedia::getProfile(std::string profileToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str())){
        return -1;
    }
...
int ClientMedia::createProfile(std::string profileName, std::string profileToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str()))
    {
        return -1;
    }
...
int ClientMedia::deleteProfile(std::string profileToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str()))
    {
        return -1;
    }
...
int  ClientMedia::addPTZConfiguration(std::string profileToken, std::string configurationToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str()))
    {
        return -1;
    }
...
int ClientMedia::addVideoSourceConfiguration(std::string profileToken, std::string configurationToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str()))
    {
        return -1;
    }
...
int ClientMedia::addVideoEncoderConfiguration(std::string profileToken, std::string configurationToken){
    if (SOAP_OK != soap_wsse_add_UsernameTokenDigest(proxyMedia.soap, nullptr, _user.c_str(), _password.c_str()))
    {
        return -1;
    }
